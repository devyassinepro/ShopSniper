                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    <li class="nk-tb-action-hidden">
                                                        <a href="{{ route('account.researchproduct.show',$product->id) }}" class="btn btn-icon btn-trigger btn-tooltip" title="Show Charts">
                                                        ...
                                                        <div class="drodown me-n1">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="{{ route('account.researchproduct.show',$product->id) }}"><em class="icon ni ni-eye"></em><span>Show Charts</span></a></li>
